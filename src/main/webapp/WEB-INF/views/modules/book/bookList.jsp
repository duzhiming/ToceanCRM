...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/book/book/">图书管理功能列表</a></li>
		<shiro:hasPermission name="book:book:edit"><li><a href="${ctx}/book/book/form">图书管理功能添加</a></li></shiro:hasPermission>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="book">
			<tr>
				...
				<td>
					<fmt:formatDate value="${book.inDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
				<td>
				...
				<shiro:hasPermission name="book:book:edit"><td>
					...
					<a href="${ctx}/book/book/delete?id=${book.id}" onclick="return confirmx('确认要删除该图书管理功能吗？', this.href)">删除</a>
